...
class FisheyeUndist:
    def __init__(self, camera_matrix, dist_coeffs, xi, fov=190, width=640 , height=360, extrinsic=None):
...
if __name__ == "__main__":
    ...
    K = np.array([[1147.1547962745608, 0, 636.2385457340097],
            [0, 1147.7663079168626,  379.116609167746],
            [0, 0, 1]])
    D = np.array([-0.1969933499414561, 0.5143322203722921, 0.00018010267972823414, 4.733099025555826e-05])
